...
#define HIN_PRINT(statement) \
    printf("\n[hin:start:%s]\n", #statement); \
    statement; \
    printf("\n[hin:end:%s]\n", #statement); \

template<typename T>
void print_qkv_params(const T& params) {
    // LLM generated
    printf("Qkv_params:\n");
    printf("q_ptr: %p\n", params.q_ptr);
    printf("k_ptr: %p\n", params.k_ptr);
...
template<typename T>
void print_flash_fwd_params(const T& params) {
    ...
    printf("oaccum_batch_stride: %ld\n", params.oaccum_batch_stride);
    printf("oaccum_row_stride: %ld\n", params.oaccum_row_stride);
    printf("oaccum_head_stride: %ld\n", params.oaccum_head_stride);
    printf("p_ptr: %p\n", params.p_ptr);
...
void print_traits() {
    ...
    printf("Kernel_traits::Is_WS      : %s\n", Kernel_traits::Is_WS ? "true" : "false");
    printf("Kernel_traits::Is_split      : %s\n", Kernel_traits::Is_split ? "true" : "false");
    printf("Kernel_traits::No_smem_O      : %s\n", Kernel_traits::No_smem_O ? "true" : "false");

    // int
    printf("Kernel_traits::kNWarps           : %d\n", Kernel_traits::kNWarps );
    printf("Kernel_traits::kNThreads         : %d\n", Kernel_traits::kNThreads );
    printf("Kernel_traits::NumProducerThreads: %d\n", Kernel_traits::NumProducerThreads );
    printf("Kernel_traits::kBlockM           : %d\n", Kernel_traits::kBlockM );
    printf("Kernel_traits::kBlockN           : %d\n", Kernel_traits::kBlockN );
    printf("Kernel_traits::kBlockH           : %d\n", Kernel_traits::kBlockH );
    printf("Kernel_traits::kHeadDim          : %d\n", Kernel_traits::kHeadDim );
    printf("Kernel_traits::kClusterM         : %d\n", Kernel_traits::kClusterM );
    printf("Kernel_traits::kStages           : %d\n", Kernel_traits::kStages );
